...
<body class="js">
    ...
    <div class="container font14">
        <div class="table-responsive">
            ...
            <tr>
                ...
                <td>
                    <a href="billdetail.php?id=<?php echo $row['sell_id'] ?>">
    ...
    <div class="container font14">
        <div class="table-responsive">
            ...
            <?php
                $sql = "select sell_id,cus_name,sell_date,sell_time,amount,s.status,status_cash from sell s left join customers c on s.cus_id=c.cus_id where status='ສັ່ງຊື້ສຳເລັດ' and s.cus_id='$cus_idfb' order by sell_date desc;";
                $result = mysqli_query($link,$sql);
                $No_ = 0;
                while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
            ?>
