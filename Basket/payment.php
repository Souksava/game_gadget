...
<body class="js">
    ...
    <?php 
        if($_SESSION['ses_id'] != ''){
            ...
            $resultckcupon = mysqli_query($link,$sqlckcupon);
            $cupon_price = 0;
                                                            ...
                                                            <div class="product-info">
                                                                ...
                                                                <div class="tab-content" id="myTabContent">
                                                                    <div class="tab-pane fade show active" id="credit" role="tabpanel">
                                                                        <div class="tab-single">
                                                                            ...
                                                                            <?php 
                                                                                ...
                                                                                $resultcredit2 = mysqli_query($link,$sqlcredit2);
                                                                            ...
                                                                            <div class="row">
                                                                                <form action="payment.php" id="formbuy" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="tab-pane fade show" id="cash" role="tabpanel">
                                                                        <div class="tab-single">
                                                                        <form action="payment.php" id="form1" method="POST" enctype="multipart/form-data">
                                                                                <div class="row">
                                                                                    <div class="col-md-12 form-group">
                                                                            ...
                                                                            <div class="row">
                                                                                <form action="payment.php" id="form1" method="POST" enctype="multipart/form-data">
                                                                                    ...
                                                                                    <div class="col-md-12 form-group">
                                                                                        ...
                                                                                        <input type="hidden" name="cupon" value="<?php echo $cupon; ?>">
                                                                                        <input type="hidden" name="cupon_price" value="<?php echo $cupon_price; ?>">
                                                                                        <input type="hidden" name="cus_id" value="<?php echo $cus_idfb; ?>">
                                                                                        <?php 
                                                                                        ?>
                                                                                    </div>  
                                                                                    <div class="col-md-12 form-group">
	...
	<footer class="footer">
        ...
        <?php 
            ...
            if(isset($_POST['btnOrdercredit'])){
                $place_deli2 = mysqli_real_escape_string($link,$_POST['place_deli']);
                ...
                if($_FILES['img_path']['name'] == ''){
                    echo"<script>";
                    echo"window.location.href='delivery.php?image=null';";
                    echo"</script>";
                }
                else { 
                    ...
                    $sqlsave = "insert into sell(sell_id,cus_id,sell_date,sell_time,amount,status,status_cash,img_path,sell_type,seen1,seen2,cupon_key,cupon_price,delivery,place_deli,note,emp_id) values('$sell_id','$cus_id2','$Date','$Time','$amount2','ສັ່ງຊື້','ເງິນໂອນ','$pro_image','online','NOTSEEN','NOTSEEN','$cupon2','$copon_price2','0','$place_deli2','-','0')";
                    $resultsave = mysqli_query($link,$sqlsave);
                    if(!$resultsave){
                        echo"<script>";
                        echo"window.location.href='basket.php?save1=false1';";
                        echo"</script>";
                    }
                    else {
                        ...
                        if(!$resultsave2){
                            echo"<script>";
                            echo"window.location.href='basket.php?save2=false2';";
                            echo"</script>";
                        }
                        else {
                            ...
                            echo"<script>";
                            echo"window.location.href='basket.php?savet=true';";
                            echo"</script>";
                        }
                    }
                }
            ...
            if(isset($_POST['btnOrdercash'])){
               ...
               // $place_deli2 = $_POST['place_deli'];
                ...
                $rowbill = mysqli_fetch_array($resultbill,MYSQLI_ASSOC);
                $sell_id = $rowbill['bill'] + 1;
                    $sqlsave = "insert into sell(sell_id,cus_id,sell_date,sell_time,amount,status,status_cash,img_path,sell_type,seen1,seen2,cupon_key,cupon_price,delivery,place_deli,note,emp_id) values('$sell_id','$cus_id2','$Date','$Time','$amount2','ສັ່ງຊື້','ເງິນສົດ','0','online','NOTSEEN','NOTSEEN','$cupon2','$copon_price2','0','$place_deli2','-','0')";
                    $resultsave = mysqli_query($link,$sqlsave);
                    if(!$resultsave){
                        echo"<script>";
                        echo"window.location.href='basket.php?save1=false1';";
