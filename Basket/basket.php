    ...
    <?php 
        if($_SESSION['ses_id'] != ''){
            ...
            if(isset($_GET['btnAdd'])){
                ...
                //implode($qty);
                $sqladd = "insert into listselldetail(pro_id,qty,color_id,cus_id) values('$pro_id','".implode($qty)."','$color_id','$cus_id');";
                    ...
                    <table class="table" style="width: 900px;">
                        ...
                        <tr>
                            ...
                            <td> 
                                ...
                                <?php 
                                    if($rowlistfb['color_id'] == "0"){
                                        echo"";
                                    }
                                    else {
                                        echo"ສີ".$rowlistfb['color_name']."";
                                    }
                                ?>
                            </td>
                            <td >
                            ...
                            <td>
                                <a href="basket.php?del=<?php echo $rowlistfb['detail_id']; ?> ">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <form action="delivery.php" method="POST" id="formdeli">
    ...
    <?php 
       if($_SESSION['fb_access_token'] != ''){
            ...
            if(isset($_GET['btnAdd'])){
                ...
                //implode($qty);
                $sqladd = "insert into listselldetail(pro_id,qty,color_id,cus_id) values('$pro_id','".implode($qty)."','$color_id','$cus_idfb');";
                $resultadd = mysqli_query($link,$sqladd);
                if(!$resultadd){
                    echo"<script>";
                    echo"alert('found');";
            ...
            if(isset($_GET['product'])){
                $pro_id = $_GET['product'];
                //implode($qty);
                $sqladd = "insert into listselldetail(pro_id,qty,color_id,cus_id) values('$pro_id','1','0','$cus_idfb');";
                $resultadd = mysqli_query($link,$sqladd);
                if(!$resultadd){
                    echo"<script>";
                    echo"alert('found');";
