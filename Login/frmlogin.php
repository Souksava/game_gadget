...
<body class="js">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <label>ຊື່ ແລະ ນາມສະກຸນ: <?php echo $user['name'];?></label><br>
    ...
    <?php 
        ...
        $loginUrl = $helper->getLoginUrl('http://localhost/GAME_GADGET/Login/fb-callback.php', $permissions);
            ...
            <div class="col mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <h5>ເຂົ້າສູ່ລະບົບ</h5>
                            <form action="../Check/checklogin.php" method="POST" id="formlogin">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <div>
                                    <a href="<?php echo htmlspecialchars($loginUrl) ?>">
                                        <img src="../icon/facebook.png" style="width: 250px; height:100px;margin-top: -15px;" alt="">
                                    </a>
                                </div>
                                <label style="color: #1563BE;"><a href="register.php">ສະມາຊິກໃໝ່ ລົງທະບຽນ</a></label>
                            </div>
                        </p>
                    </div>
                </div>
