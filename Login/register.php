				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-12 col-12">
						...
						<div class="right-content font14">
							<ul class="list-main">
                                <li><i class="ti-user"></i> <a href="register.php">ລົງທະບຽນ</a></li>
                                <li><i class="ti-power-off"></i><a href="frmlogin.php">ເຂົ້າສູ່ລະບົບ</a></li>   
							</ul>
						</div>
						<!-- End Top Right -->
					</div>
						...
						<div class="col-lg-6 col-12">
							...
							<?php 
                                ...
                                if(isset($_POST['btnRegister'])){
                                    ...
                                    if(trim($cus_name) == ""){
                                        echo"<script>";
                                        echo"window.location.href='register.php?cus_name=null';";
                                        echo"</script>";
                                    }
                                    elseif (trim($cus_surname) == "") {
                                        echo"<script>";
                                        echo"window.location.href='register.php?cus_surname=null';";
                                        echo"</script>";
                                    }
                                    elseif (trim($gender) == "") {
                                        echo"<script>";
                                        echo"window.location.href='register.php?gender=null';";
                                        echo"</script>";
                                    }
                                    elseif (trim($address) == "") {
                                        echo"<script>";
                                        echo"window.location.href='register.php?address=null';";
                                        echo"</script>";
                                    }
                                    elseif (trim($tel) == "") {
                                        echo"<script>";
                                        echo"window.location.href='register.php?tel=null';";
                                        echo"</script>";
                                    }
                                    elseif (trim($email) == "") {
                                        echo"<script>";
                                        echo"window.location.href='register.php?email=null';";
                                        echo"</script>";
                                    }
                                    elseif (trim($pass) == "") {
                                        echo"<script>";
                                        echo"window.location.href='register.php?pass=null';";
                                        echo"</script>";
                                    }
                                    elseif (trim($requetpass) == "") {
                                        echo"<script>";
                                        echo"window.location.href='register.php?requetpass=null';";
                                        echo"</script>";
                                    }
                                    else {
                                        ...
                                        if(mysqli_num_rows($resultckemail) > 0){
                                            echo"<script>";
                                            echo"window.location.href='register.php?emaill2=false';";
                                            echo"</script>";
                                        }
                                        elseif (trim($pass) != trim($requetpass)) {
                                            echo"<script>";
                                            echo"window.location.href='register.php?pass2=false';";
                                            echo"</script>";
                                        }
                                        else {
                                            ...
                                            $resultregister = mysqli_query($link,$sqlregister);
                                            if(!$resultregister){
                                                echo"<script>";
                                                echo"window.location.href='register.php?save=false';";
                                                echo"</script>";
                                            }
                                            else {
                                                echo"<script>";
                                                echo"window.location.href='frmlogin.php?savere=truere';";
                                                echo"</script>";
                                            }
                                        }
                                    }
