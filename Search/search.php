				...
				<div class="row">
                    <div class="col-lg-2 col-md-2 col-12">
						...
						<div class="search-top">
							...
							<!-- Search Form -->
							<div class="search-top">
								<form action="search.php" method="GET" id="formserach" class="search-form">
					...
					<div class="col-lg-8 col-md-7 col-12">
						<div class="search-bar-top">
							<div class="search-bar">
								<form action="search.php" method="GET" id="formserach">
									...
									<div class="navbar-collapse">	
										<div class="nav-inner">	
											<ul class="nav main-menu menu navbar-nav">
													<li class="active"><a href="../index.php">ໜ້າຫຼັກ</a></li>																		
						...
						<div class="product-info">
							<div class="tab-content" id="myTabContent">	
									<div class="tab-single">
										<div class="row">
											<?php 
												$sqlprobrand = "select p.pro_id,pro_name,brand_name,p.status,promotion,p.promotion,cated_name,cate_name,p.price,p.img_path,p.price-promotion as newprice,(promotion/p.price) * 100 as persen from product p left join brand b on p.brand_id=b.brand_id left join categorydetail d on p.cated_id=d.cated_id left join category c on d.cate_id=c.cate_id where cated_name like '$id' or brand_name like '$id' or pro_name like '$id' or p.pro_id like '$id' order by p.pro_name;";
